/*
 ...
 refind-btrfs - Generate rEFInd manual boot stanzas from Btrfs snapshots Copyright (C) 2020-2022
 Luka Žaja
...
options {
	tokenVocab = RefindConfigLexer;
}

refind: config_option* EOF;

config_option: boot_stanza | include;
